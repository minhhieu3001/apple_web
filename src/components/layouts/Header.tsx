...
export default function Header({color}: PropsType) {
  ...
  return (
    <div style={{ backgroundColor: color, height: '5vh', justifyContent: 'center', display: 'flex', position: 'fixed', top: 0, left: 0, right: 0}}>
      ...
      <AppleFilled style={{ color: iconColor, alignSelf: 'center', padding: '10px' }} />
      ...
      <SearchOutlined style={{ color: iconColor, alignSelf: 'center', padding: '10px' }} />
      <ShoppingCartOutlined style={{ color: iconColor, alignSelf: 'center', padding: '10px' }}/>
    </div>
  )
}
